...
// let firstName="mustafa"
// let age=25
// let result = `my name is ${firstName} and I am ${age} yers old`
// console.log(result);
...
// function greet(name){
//     let namegreet=`приветствие,${name}`;
...
// let ad=["str","str","str","str","str","str"]
// let resultad=ad.join();
// console.log(ad);
...
// // 32. Объявите строку и преобразуйте её в массив символов.
// let text="mustafa"
// let textmustafa=text.length
// console.log(textmustafa);

// Объявление многомерного массива
// 34. Объявите массив массивов (двумерный массив).

// const mordovorot=[["musa","isa"],["tima","mira"]]
// console.log(mordovorot);
